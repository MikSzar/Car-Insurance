...
<head>
    ...
    <title>Period of your car insurance has been exceeded.</title>
...
<div align="center">
    ...
    <h2>${insurance.name} with registration number: ${insurance.registrationNumber},
        does not have an ongoing insurance, which according to the regulations, means that the value of compensation to be paid is 0 PLN.
         If you want more information please contact our hotline: +48 222 333 444.
    </h2>
